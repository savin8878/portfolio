...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-border/50 overflow-hidden">
      ...
      <div className="absolute inset-0 dot-grid mask-fade-b opacity-30 -z-10" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-20">
          ...
          <motion.div
            ...
            className="mb-16 pb-12 border-b border-border/50"
          >
              ...
              <div className="mt-7 flex gap-2">
                {socialLinks.map((social) => (
                  <Link
                    key={social.label}
                    href={social.href}
                    className="group relative p-2.5 rounded-full bg-muted/40 border border-border/50 text-muted-foreground hover:text-foreground hover:border-accent/40 hover:bg-accent/5 transition-all duration-300"
                    target="_blank"
